...
#include_graphics(here::here("static","data","covid_death_rate_comorbidities.png"), error = FALSE)
#include_graphics(here::here("static","data","covid_death_rate_icu.png"), error = FALSE)
