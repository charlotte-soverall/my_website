...
#knitr::include_graphics(here::here("data","blogs","covid_death_rate_comorbidities.png"), error = FALSE)
#knitr::include_graphics(here::here("data","blogs","covid_death_rate_icu.png"), error = FALSE)

include_graphics(here::here("data","blogs","covid_death_rate_comorbidities.png"), error = FALSE)
include_graphics(here::here("data","blogs","covid_death_rate_icu.png"), error = FALSE)
